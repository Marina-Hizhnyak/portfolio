...
const Projects = ref([
    {
        ...
        image: '/src/assets/webshop.png',
        title: 'Webshop',
        description: 'BShop is a modern e-commerce platform built to provide a seamless online shopping experience. The platform features a user-friendly interface, product listings, and a smooth checkout process. Designed with responsive design principles, BShop ensures that users can easily browse and purchase items from any device.',
        technologies: ['javascript', 'vite', 'bootstrap'],
        gitURL: 'https://github.com/Marina-Hizhnyak/webshop',
        webURL: 'https://webshopbshop.vercel.app/'
    },
    {
        id: 2,
        category: 'web development',
        ...
        title: 'Portfolio',
        description: 'This portfolio showcases my web development skills through various projects, designed with Vue.js 3 and Tailwind CSS for a modern, responsive user experience. It highlights my proficiency in creating dynamic, interactive applications with a clean and minimalist design approach.',
        technologies: ['vue.js 3', 'tailwind css', 'html', 'javascript'],
        gitURL: '',
        webURL: ''
    },
    {
        ...
        title: 'catalogue',
        description: 'Catalogue Maryk is an intuitive product catalog platform designed for easy navigation and exploration of various items. The platform focuses on providing users with a clean and organized interface, ensuring a smooth browsing experience. Built with responsiveness in mind, it adapts seamlessly to different devices and screen sizes.',
        technologies: ['html', 'php', 'bootstrap'],
        gitURL: 'https://github.com/Marina-Hizhnyak/catalogue_mvc',
        webURL: 'http://catalogue.maryk.be/'
    },
