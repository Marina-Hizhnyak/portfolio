        ...
        <div class="lg:py-6">
          <div class="text-center lg:text-left">
            <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
              Hi, I'm <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500">Maryna</span>
               🙂
            </h1>
          </div>
          <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">I am a driven front-end developer with a strong foundation in HTML, CSS, PHP and JavaScript. Eager to grow in a dynamic environment, I stay updated on the latest industry trends and best practices. With a proactive attitude and passion for continuous learning, I'm excited to contribute my skills and fresh perspective to impactful projects.
          </p>
              ...
              <div class="hover:scale-105 transition-all ease-in-out flex justify-center items-center relative">
                <div class="svg-container">
                  <svg class="download-icon" width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="download-arrow" d="M13 9L9 13M9 13L5 9M9 13V1" stroke="#f59e0b" stoke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="lg:h-full md:flex">
          <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
            ...
            <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary">
              <img src="@/assets/photo2.jpg" alt="Hero picture" width="500" height="auto" loading="lazy" class="w-full h-full rounded-full object-cover">
            </div>
