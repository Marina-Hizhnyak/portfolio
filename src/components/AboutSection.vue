    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
                ...
                <div class="space-y-8 py-8">
                    ...
                    >
                        ...
                        <div class="w-3/4 pl-4">
                            ...
                            <p class="text-white">{{ element.country }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">Motivated Front-End Developer with a Passion for Learning and Growth I am a highly motivated and quick learner with a strong foundation in HTML, CSS, and JavaScript, eager to contribute and grow in a dynamic development environment. While I may not have professional experience yet, I am deeply committed to mastering front-end development. My proactive attitude and dedication to continuous improvement drive me to stay updated with the latest industry trends and best practices. I'm excited to apply my skills, enthusiasm, and fresh perspective to contribute to meaningful projects.
                </p>
                <div class="grid grid-cols-3 gap-4 max-w-lg pt-8">
                    <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        ...
                        <p class="text-sm sm:text-base text-gray-300">Personal Projects</p>
                    </div>
                    <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        <h3 class="text-white font-bold text-xl sm:text-2xl lg:text-3xl">+300</h3>
                        <p class="text-sm sm:text-base text-gray-300">Hours of Study</p>
                    </div>

                    <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        <h3 class="text-white font-bold text-xl sm:text-2xl lg:text-3xl">Eager</h3>
                        <p class="text-sm sm:text-base text-gray-300">To Learn and Grow</p>
                    </div>
                </div>
            </div>
        </div>
...
const education=ref([
    {
        id:1,
        School:'Ifosup',
        program:'Web Development BES Training',
        year: '2023-...',
        country: 'Belgium',
    },
    {
        id:2,
        School:'National Academy of Civil Engineering and Architecture of Donbass',
